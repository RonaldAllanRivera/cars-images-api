...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            // FilamentInfoWidget is the framework's own promo card; it used to
            // sit above the pipeline stats on an otherwise empty landing page.
            // The dashboard widgets in App\Filament\Widgets are picked up by
            // discoverWidgets() above and need no registration here.
            ->widgets([
                AccountWidget::class,
            ])
            ->middleware([
